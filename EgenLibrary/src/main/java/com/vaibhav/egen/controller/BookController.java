...
public class BookController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/checkout/{book_id}/{user_id}")
	public @ResponseBody Status addbook(@PathVariable Long book_id, @PathVariable Long user_id) throws Exception {

		System.out.println("addBook()");
		Book newbook = (Book) bookServices.getBookById(book_id);
	...
	public @ResponseBody Status addbook(@RequestBody String jsonString) throws Exception {
...
*/
	...
	Status updatebook(@PathVariable Long book_id, @RequestBody Book book) {
		try {
